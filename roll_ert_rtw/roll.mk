###########################################################################
## Makefile generated for component 'roll'. 
## 
## Makefile     : roll.mk
## Generated on : Fri Jan 02 09:16:06 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\roll.exe
...
COMPILER_COMMAND_FILE     = roll_comp.rsp
CMD_FILE                  = roll.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\roll.exe
...
DEFINES_STANDARD = -DMODEL=roll -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\roll_ert_rtw\roll.cpp

MAIN_SRC = $(START_DIR)\roll_ert_rtw\ert_main.cpp
...
{$(START_DIR)\roll_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\roll_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\roll_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\roll_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\roll_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\roll_ert_rtw\ert_main.cpp"


roll.obj : "$(START_DIR)\roll_ert_rtw\roll.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\roll_ert_rtw\roll.cpp"
