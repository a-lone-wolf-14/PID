###########################################################################
## Makefile generated for component 'heave'. 
## 
## Makefile     : heave.mk
## Generated on : Fri Jan 02 02:29:27 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\heave.exe
...
COMPILER_COMMAND_FILE     = heave_comp.rsp
CMD_FILE                  = heave.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\heave.exe
...
DEFINES_BUILD_ARGS = -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTERMFCN=0 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=1 -DINTEGER_CODE=0 -DMT=1
DEFINES_CUSTOM = 
DEFINES_OPTS = -DTID01EQ=0
DEFINES_STANDARD = -DMODEL=heave -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\heave_ert_rtw\heave.cpp

MAIN_SRC = $(START_DIR)\heave_ert_rtw\ert_main.cpp
...
{$(START_DIR)\heave_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\heave_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\heave_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\heave_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\heave_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\heave_ert_rtw\ert_main.cpp"


heave.obj : "$(START_DIR)\heave_ert_rtw\heave.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\heave_ert_rtw\heave.cpp"
